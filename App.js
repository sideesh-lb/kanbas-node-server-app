...
const CONNECTION_STRING = process.env.DB_CONN_STRING || 'mongodb://127.0.0.1:27017';
const FRONT_END_STRING = process.env.FRONTEND_URL_NETLIFY || process.env.FRONTEND_URL;
